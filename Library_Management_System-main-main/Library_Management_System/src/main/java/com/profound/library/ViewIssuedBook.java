...
public class ViewIssuedBook extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
	{
		...
		out.println("<tr style='background-color:aqua'><th>Book ID</th><th>Student Id</th><th>Student Name</th><th>Student Mobile</th><th>Issued Date</th><th>Return Status</th></tr>");
		for (IssueBookBean bean : list) {
			out.println("<tr><td>" + bean.getbookid() + "</td><td>" + bean.getStudentid() + "</td><td>"
					+ bean.getStudentname() + "</td><td><font color='green'>" + bean.getStudentmobile()
					+ "</font></td><td>" + bean.getIssueddate() + "</td><td><font color='red'>" + bean.getReturnstatus()
					+ "</font></td></tr>");
		}
		out.println("</table>");

...
public class ViewBookFine extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
	{
		...
		try {
			...
			out.println(
					"<tr><th>Book Id</th><th>Roll No.</th><th>Name</th><th>Mobile No.</th><th>Issue Date</th><th>Return Date</th><th>Days</th><th>Status</th><th>Fine Amount</th></tr>");
			...
			while (rs.next()) {
				...
				out.println("<tr><td>" + rs.getInt(1) + "</td><td>" + rs.getInt(2) + "</td><td>" + rs.getString(3)
						+ "</td><td>" + rs.getLong(4) + "</td><td>" + rs.getString(5) + "</td><td>" + rs.getString(6)
						+ "</td><td>" + rs.getInt(7) + "</td><td><font color='green'>" + rs.getString(8)
						+ "</font></td><td><font color='red'>" + rs.getLong(9) + "</font></td></tr>");
			}
		} catch (Exception e) {
		}
		;
